...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _enoughCounts = MutableLiveData<Boolean>()
    val enoughCounts: LiveData<Boolean>
        get() = _enoughCounts
    ...
    private fun updateProgress() {
        ...
        _enoughCounts.value = countOfRightAnswers >= gameSettings.minCountOfRightAnswers
    ...
    private fun finishGame() {
        _gameResult.value = GameResult(
            enoughCounts.value == true && enoughPercent.value == true,
            countOfRightAnswers,
            countOfQuestions,
            gameSettings
        )
